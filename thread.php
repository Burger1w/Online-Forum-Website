...
<body>
    ...
    while ($row = mysqli_fetch_assoc($result)) {
     ...
     //query the users table to find the the name of posted by
    ...
    <div class="container">
        <div class="jumbotron my-4" style="background-color:#E9ECEF;">
            <h1 class="display-4 mx-4"> <?php echo $title; ?></h1>
            <p class="lead mx-4"> <?php echo $desc; ?></p>
            <hr class="my-1">
            <p class="mx-4 mt-2 pb-0"> Comments and contributions to forum threads or posts should be descriptive, succinct, and relevant to discussion or forum topic.</p>
            <p class="mx-4 pb-2">  Posted by : <i><?php echo $posted_by ; ?></i></p>
        </div>
        ...
        <form action=" ' . $_SERVER['REQUEST_URI'] . '" method="POST">
            <div class="form-group">
                <label for="desc">Type tour Comment</label>
    ...
    <p class="lead ">You are not logged in.Please  login to able to post a comment.</p>
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            <div class="media-body">
               <b><p class="font-weight-bold my-0"><b?>'.$row2['user_email'].' </b> at ' . $comment_time . '</p></b>
                ' . $content . '
            </div>
        </div>';
        }
